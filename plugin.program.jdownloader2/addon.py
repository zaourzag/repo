...
addonID = "plugin.program.jdownloader2"
...
addon_name = xbmcaddon.Addon(addonID).getAddonInfo('name')
...
def list_server(server_id):
    ...
    list.extend(get_item_sever())  # add 'downloads' and 'linkgrabber'
