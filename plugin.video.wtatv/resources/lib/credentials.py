...
class Credentials:
    ...
    def run(self):
        if self.email and self.password:
            ...
            self.email = dialog.input('WTA Login: Email', type=xbmcgui.INPUT_ALPHANUM)
            self.password = dialog.input('WTA Login: Password', type=xbmcgui.INPUT_ALPHANUM, option=xbmcgui.ALPHANUM_HIDE_INPUT)
