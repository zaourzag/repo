...
def login():
  ...
  headers = {'User-Agent':         'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36',
   ...
   'Referer':                      'https://www.fohlen.tv/',
   'Content-Type':                  'application/x-www-form-urlencoded; charset=UTF-8',
   'Origin':                        'https://www.fohlen.tv',
   'Accept-Encoding':'gzip, deflate, br',
   'Accept-Language': 'de-DE,de;q=0.9,en-US;q=0.8,en;q=0.7'
   }
  data = urllib.urlencode(values)
  debug("Data : "+data)
  content = requests.post("https://www.fohlen.tv/user/login",data=data, allow_redirects=False,verify=False,cookies=cj,headers=headers)
...
#    auswahl_qual="source_"+quality
    ...
    addDir("Budnesliega", "https://www.fohlen.tv/video/bundesliga", "subrubrik","")
    for element in elemente:
       title= element["title"]
       if not "bundesliga" in element["href"]:         
        addDir(title, "https://www.fohlen.tv"+element["href"], "subrubrik","")
...
def subrubrik(url):
  ...
  try:
      ...
      for element in elemente :
        title= element["title"]        
        addDir(title, "https://www.fohlen.tv"+element["href"], "videoliste","")
...
def playvideo(url):      
    ...
    newurl="https://www.fohlen.tv"+newurl
