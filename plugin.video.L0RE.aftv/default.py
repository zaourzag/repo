...
baseurl="https://www.aftv-online.de"
...
#    auswahl_qual="source_"+quality
    ...
    content=geturl("https://www.aftv-online.de")
    htmlPage = BeautifulSoup(content, 'html.parser')
    elemente = htmlPage.find_all("a",attrs={"class":"teaser"})
    addDir("Budnesliega", "https://www.aftv-online.de/video/bundesliga", "subrubrik","")
    for element in elemente:
       title= element["title"]
       if not "spiele/" in element["href"]:         
        addDir(title, "https://www.aftv-online.de"+element["href"], "subrubrik","")    
...
def subrubrik(url):
  ...
  try:
      ...
      for element in elemente :
        title= element["title"]        
        addDir(title, "https://www.aftv-online.de"+element["href"], "videoliste","")
...
def playvideo(url):      
    ...
    newurl="https://www.aftv-online.de"+newurl
...
def videoliste(url,page=1,nosub=0):  
  ...
  for element in elemente:
       ...
       link="https://www.aftv-online.de"+link
       bild = element.find("img")["src"]
       bild="https://www.aftv-online.de"+bild
